...
export const blogPosts: BlogPost[] = [
  {
    slug: "understanding-yacht-insurance-nz",
    title: "Understanding Yacht Insurance in New Zealand: A Complete Guide",
    excerpt:
      "Learn everything you need to know about yacht insurance in New Zealand, from coverage types to choosing the right provider for your vessel.",
    author: "Liam Ngata",
    date: "2026-04-01",
    image:
      "https://images.unsplash.com/photo-1540946485063-a40da27545f8?w=1600&h=900&fit=crop",
    category: "Guides",
    readTime: 8,
    content: `# Understanding Yacht Insurance in New Zealand: A Complete Guide

Yacht insurance in New Zealand is a crucial investment for anyone who owns or operates a vessel. Whether you sail for pleasure, compete in racing events, or use your boat for commercial purposes, comprehensive insurance coverage protects your financial interests and provides peace of mind on the water.

## What is Yacht Insurance?

Yacht insurance is a specialized form of marine insurance designed to protect boat and yacht owners against various risks. These risks include collision damage, theft, loss of the vessel, third-party liability claims, and other maritime perils. In New Zealand, the marine insurance market is well-developed, with multiple insurers offering competitive coverage options tailored to different vessel types and usage patterns.

## Types of Coverage Available

New Zealand insurers typically offer several coverage types that can be combined to create a comprehensive policy:

**Hull Coverage** protects the physical structure of your vessel against damage from collisions, storms, sinking, and other maritime perils. Most policies offer agreed value coverage, meaning your insurer has pre-agreed to the value of your vessel, simplifying claims settlement.

**Third-Party Liability** is essential protection that covers legal liability for damage or injury you cause to other vessels, people, or property. This coverage is often required by marinas and mooring facilities in New Zealand.

**Salvage and Towing** covers the cost of professional assistance if your vessel becomes disabled or stranded. New Zealand's extensive coastline and sometimes challenging weather conditions make this coverage particularly valuable.

**Crew Protection** provides medical expense coverage for crew members injured while aboard your vessel, offering important financial protection during maritime accidents.

## Factors Affecting Your Premium

Your yacht insurance premium depends on several key factors. The type of vessel significantly impacts your rate – high-performance racing yachts typically cost more to insure than cruising vessels. The age and condition of your boat also matter, as older vessels may be considered higher risk. Your location and where you typically sail influence rates; vessels moored in exposed locations command higher premiums.

Your claims history, crew experience, and the safety equipment installed on your vessel all factor into the final premium calculation. Most insurers offer discounts for safety courses, alarm systems, and other risk-mitigation measures.

## Choosing the Right Insurer

When selecting yacht insurance in New Zealand, compare quotes from multiple providers but don't focus solely on price. Evaluate the quality of claims service, the breadth of coverage options available, and the insurer's reputation in the marine insurance market. Read reviews from other boat owners and check how long insurers typically take to settle claims.

Consider whether an insurer specializes in your type of vessel and usage pattern. Some providers excel with racing yacht insurance, while others focus on cruising vessels or motor yachts. Specialist insurers often offer better rates and more suitable coverage for your specific needs.

## Common Exclusions to Understand

Most yacht insurance policies exclude coverage for racing unless you specifically purchase racing coverage. Wear and tear, mechanical breakdowns unrelated to an insured event, and usage outside the declared cruising area are typically not covered. Many policies also exclude claims arising from alcohol or drug impairment of the operator.

Understanding your policy's specific exclusions is critical. Review the policy document thoroughly and ask your insurer about any exclusions that concern you. You can often purchase additional coverage to address specific exclusion gaps.

## Taking Action

Protecting your yacht investment through comprehensive insurance is one of the most important decisions you'll make as a boat owner. Start by gathering quotes from several insurers, ensuring you're comparing similar coverage levels. Discuss your intended usage with each insurer to ensure they can accommodate your specific needs.

Once you've selected an insurer, review your policy annually. Changes in your vessel's value, your cruising patterns, or your crew composition may warrant policy adjustments. Regular policy reviews ensure you maintain adequate coverage as your boating activities evolve.`,
  },
  {
    slug: "top-5-yacht-insurance-risks-nz",
    title: "Top 5 Risks Every NZ Boat Owner Should Insure Against",
    excerpt:
      "Discover the most significant risks facing boat owners in New Zealand waters and how proper insurance protects you from financial loss.",
    ...
    readTime: 7,
    content: `# Top 5 Risks Every NZ Boat Owner Should Insure Against

New Zealand's diverse marine environment presents boat owners with unique risks and challenges. From severe weather systems to remote cruising locations, understanding the primary threats to your vessel enables you to secure appropriate insurance coverage. Here are the five most significant risks every New Zealand boat owner should protect against.

## 1. Storm and Weather Damage

New Zealand is renowned for dramatic and sometimes violent weather patterns. Storms can cause substantial damage to vessels, including hull breaches, damaged masts, lost rigging, and flooding. The Southern Ocean generates powerful swells and unpredictable weather systems, particularly during autumn and winter months.

Comprehensive hull coverage protects your vessel against storm damage, regardless of whether you're actively sailing or moored in a marina. This coverage ensures that expensive repairs won't drain your personal finances. Many claims in New Zealand stem from storm damage, making this one of the most important coverage areas.

## 2. Collision and Accidents

Collisions represent a significant risk in New Zealand's busy harbors, especially around Auckland, Wellington, and Christchurch. Whether caused by operator error, equipment failure, or other vessels' negligence, collision damage can be catastrophic and extremely expensive to repair.

Third-party liability coverage becomes critical when you're found responsible for collision damage to other vessels. In New Zealand, courts have awarded substantial damages in maritime accident cases. Protecting yourself with liability coverage is not only financially prudent but often required by marinas and mooring facilities.

## 3. Theft and Break-ins

Vessel theft and theft of equipment from boats remains a persistent problem in New Zealand, particularly at remote moorings and marinas. Thieves target valuable marine electronics, engines, safety equipment, and personal items stored aboard vessels.

Comprehensive insurance with theft coverage protects your vessel and the equipment installed on it. Additional personal effects coverage can protect belongings stored aboard your boat. Security measures like alarms and GPS tracking devices can reduce premiums while providing ongoing protection.

## 4. Third-Party Liability Claims

If your vessel causes injury to another person, damage to their property, or environmental contamination, you could face substantial legal liability. A serious injury to a swimmer or another boater could result in six-figure claim costs. Damage to another vessel could easily reach hundreds of thousands of dollars.

Third-party liability coverage is essential for all boat owners in New Zealand. Most policies include at least basic liability protection, but some owners purchase higher limits to ensure comprehensive protection against catastrophic claims.

## 5. Mechanical Failure and Emergency Towing

While mechanical failure isn't typically covered under standard hull policies, the costs of engine failure, electrical problems, or other mechanical breakdowns can be substantial when you're far from port. Emergency towing costs alone can exceed several thousand dollars in New Zealand's remote waters.

Salvage and towing coverage helps protect against these substantial emergency costs. This coverage has saved many boat owners from financial disaster when engine failure or grounding occurs in isolated locations. For those who frequently venture offshore, this coverage is particularly valuable.

## Creating Your Coverage Strategy

Evaluating your specific risks and usage patterns helps determine the right insurance combination. Consider where you typically moor your vessel, how far offshore you venture, your crew's experience level, and the typical weather conditions you encounter.

Work with your insurer to ensure your coverage matches your actual exposure to these risks. Regular policy reviews ensure your protection remains adequate as your boating activities and vessel circumstances change.`,
  },
  {
    slug: "coastal-cruising-bay-islands-fiordland",
    title: "Coastal Cruising in NZ: Insurance Considerations for Bay of Islands to Fiordland",
    excerpt:
      "Planning a coastal cruising adventure from Bay of Islands to Fiordland? Learn what insurance coverage you'll need for this iconic New Zealand journey.",
    ...
    category: "Cruising",
    readTime: 9,
    content: `# Coastal Cruising in NZ: Insurance Considerations for Bay of Islands to Fiordland
...
The Bay of Islands to Fiordland voyage represents an unforgettable New Zealand experience. With appropriate insurance coverage that specifically addresses the unique challenges of extended coastal cruising, you can focus on enjoying the spectacular scenery and world-class anchorages rather than worrying about financial protection.`,
  ...
  {
    slug: "jet-ski-insurance-nz",
    title: "Jet Ski Insurance NZ: What You Need to Know Before Hitting the Water",
    excerpt:
      "Everything you need to know about jet ski insurance in New Zealand, from coverage types to cost-saving tips for personal watercraft owners.",
    author: "Aroha Patel",
    date: "2026-03-20",
    image:
...
Jet skis and personal watercraft represent the fastest-growing segment of recreational boating in New Zealand. These nimble water sports vessels provide thrilling experiences and access to otherwise hard-to-reach water areas. However, the high speeds and acrobatic capabilities that make jet skis exciting also create significant insurance considerations that every owner should understand.

## Why Jet Ski Insurance Matters

Jet ski insurance provides essential protection against the unique risks associated with personal watercraft operation. Unlike larger vessels, jet skis offer minimal protection to their operators and passengers in collision scenarios. This increased personal injury risk makes comprehensive insurance coverage critical.

Additionally, jet ski liability insurance protects you against claims from other water users you might injure or other vessels you might damage. A collision between a jet ski and a swimmer or sailboat could result in catastrophic injuries and substantial liability claims. Insurance transforms these potential financial disasters into manageable claims.

## Coverage Types for Jet Skis

**Theft and Loss Coverage** protects against the most common claims on personal watercraft. Jet skis are particularly vulnerable to theft, especially at beach access points and boat ramps. Coverage typically includes lockable storage requirements and GPS tracking discounts.

**Collision and Damage Coverage** provides protection for damage to your jet ski from collisions with other objects, including other vessels, mooring structures, or rocks. Many policies differentiate between collision damage and weather-related damage.

**Liability Coverage** remains the most important protection for jet ski owners. This coverage protects you financially if you cause injury to another person or damage another vessel. New Zealand courts have awarded substantial damages in personal watercraft accident cases.

**Medical Payments Coverage** provides benefits for medical treatment of you or your passengers regardless of fault. This coverage proves invaluable for minor injuries that don't result in liability claims but require immediate medical attention.

## Factors Affecting Your Jet Ski Premium

Your jet ski's age, condition, and brand significantly influence your premium. Newer models with more powerful engines typically cost more to insure than older, smaller-displacement models. Some insurers specialize in specific brands and offer better rates for those models.

Your age and operating experience affect rates substantially. Operators under 25 typically pay higher premiums than older riders, reflecting statistically higher accident rates. Taking a jet ski safety course can reduce premiums by 10-15% with most insurers.

Where you store your jet ski and where you typically operate it influences your premium. Jet skis stored in secure, gated facilities command lower rates than those left at public beach access points. Operating primarily in sheltered harbors costs less than open ocean conditions.

## Safety Requirements and Course Discounts

Most NZ insurers require jet ski operators to have completed an approved water safety course. The Boating Safety Institute offers recognized courses that fulfill these requirements and often qualify for insurance discounts. Taking an advanced jet ski handling course can result in additional premium reductions.

Many insurers require that the jet ski be equipped with safety equipment including a functioning cut-off lanyard, properly functioning kill switch, and adequate life jacket availability for all occupants. Some insurers specifically require Coast Guard-approved life jackets rather than general swimming aids.

## Age and Experience Restrictions

Insurers often restrict who can operate the insured jet ski. Many policies require that operators be at least 18 years old and hold a valid boating license. Some insurers impose higher excesses for operators under 25 or limit coverage for operators without prior jet ski experience.

Clearly communicate all potential operators to your insurer before purchasing coverage. Failing to disclose that a teenage family member will frequently operate the jet ski could result in coverage denial if that operator is involved in an incident.

## Cost-Saving Strategies

Bundling your jet ski insurance with other insurance policies (home, car, or boat insurance) frequently results in multi-policy discounts of 10-20%. Comparing quotes from multiple insurers is essential, as jet ski rates vary significantly between providers.

Installing a GPS tracking device on your jet ski can reduce premiums by 10-15% with most insurers. Completing a safety course before purchasing insurance typically results in discounts that more than offset the course cost. Storing your jet ski in a secure facility rather than leaving it accessible reduces theft risk and premium costs.

## Getting the Right Coverage

Start by obtaining quotes from multiple insurers and comparing coverage details, not just premium prices. Discuss your typical operating patterns, the water conditions where you'll ride, and your crew composition. Some insurers offer specialized jet ski coverage with features designed specifically for personal watercraft owners.

Ensure your chosen policy covers the specific areas where you typically operate your jet ski. If you plan to venture into rougher coastal waters, confirm that your policy doesn't restrict coverage in more exposed areas. Understanding your coverage before purchasing provides confidence that you have appropriate protection.`,
  },
  {
    slug: "choosing-marine-insurance-nz",
    title: "How to Choose the Right Marine Insurance Provider in New Zealand",
    excerpt:
      "A practical guide to selecting the best marine insurance provider for your vessel, with tips for comparing quotes and evaluating coverage options.",
    author: "Callum Te Awa",
    date: "2026-03-15",
    image:
      "https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?w=1600&h=900&fit=crop",
    category: "Insurance Tips",
    readTime: 7,
    content: `# How to Choose the Right Marine Insurance Provider in New Zealand

Selecting the right marine insurance provider is one of the most important decisions a boat owner makes. With multiple insurers offering varying coverage options at different price points, the selection process can feel overwhelming. However, following a systematic approach helps ensure you find an insurer that provides the right coverage at a fair price.

## Assess Your Insurance Needs

Before comparing providers, clearly identify what coverage you actually need. Your vessel type, age, value, and intended usage patterns determine which coverage components are essential. A racing yacht requires different coverage than a weekday cruiser. A jet ski needs different protection than a large commercial fishing vessel.

Create a list of your specific requirements. Include the vessel's replacement value, the geographic area where you'll typically cruise, any competitive usage, crew composition, and any specialized equipment you want covered. This detailed needs assessment guides your provider selection process.

## Research Insurer Reputation and Financial Stability

An insurer's reputation and financial stability matter as much as their premium prices. Research each insurer's ratings with complaint and review websites. Check their ratings with the Financial Markets Authority to ensure they maintain proper capital reserves. An insurer offering extremely low prices might not maintain the financial reserves to pay large claims.

Talk to other boat owners in your area about their experiences with different insurers. Ask specifically about their claims experiences, how quickly claims were settled, and whether the insurer supported them through the process. Personal recommendations from fellow boaters often provide the most realistic assessment of an insurer's service quality.

## Compare Coverage and Exclusions

Don't make price your only comparison criterion. Request detailed policy documents from your top three insurer choices and compare the specific coverage provided. Look beyond headline coverage limits and examine the fine print covering exclusions, conditions, and limitations.

Pay particular attention to exclusions that might affect your intended usage. If you plan to race your yacht, confirm that racing coverage is available and understand the additional cost. If you'll cruise offshore, verify that your policy covers your intended cruising area. If you operate in remote locations, confirm that salvage and assistance coverage extends to those areas.

## Evaluate Claims Process and Customer Service

An insurer's claims process becomes critical if you ever experience marine damage. Some insurers process claims within days, while others take weeks. Some designate local claims adjusters who understand local conditions, while others use national adjusters unfamiliar with marine operations.

Call each insurer's claims line and evaluate their responsiveness. Ask about their average claims settlement timeline. Find out whether they have local representatives in your area. Some insurers partner with approved repairers, which can streamline the repair process, while others allow you to choose any repairer.

## Investigate Available Discounts

Most insurers offer multiple discount opportunities that can substantially reduce your premium. Safety course discounts, alarm system discounts, and multi-policy bundling discounts are common. Some insurers offer loyalty discounts for long-term customers. Others reduce premiums for vessels with excellent maintenance records.

Ask each insurer about their complete range of available discounts. Calculate your actual net cost after applying all applicable discounts before making your final comparison. An insurer with a higher base rate might ultimately provide the lowest net premium when all discounts are applied.

## Consider Specialist vs. Generalist Insurers

Specialist marine insurers dedicate their entire business to marine insurance and employ marine underwriters with deep expertise. They often provide better advice about your specific coverage needs and may offer more flexible coverage options for unusual vessels or situations.

Generalist insurers offering marine coverage alongside auto, home, and life insurance often provide competitive rates and convenient multi-policy bundling. However, they might lack the deep marine expertise of specialists. The right choice depends on your specific situation and preferences.

## Verify Customer Access and Policy Management

Modern insurers increasingly offer online policy management, allowing you to adjust coverage, view policy documents, and manage claims online. Consider whether digital access matters to you. Some boaters prefer dealing with a local agent who understands their vessel personally, while others appreciate the convenience of online management.

Confirm that your chosen insurer provides 24/7 access to their claims hotline, particularly important for marine incidents that might occur outside business hours. The ability to report incidents immediately and receive emergency support instructions is critical for maritime safety.

## Make Your Final Decision

Once you've completed your research, obtain formal quotes from your top two or three insurer choices. Request that each quote clearly itemize the coverage provided, all applicable discounts, and the total annual premium. Request clarification on any coverage differences between quotes.

Choose the insurer that provides the best combination of appropriate coverage, fair pricing, strong reputation, and excellent customer service. Review your chosen policy annually and reassess whether your coverage remains adequate for your current vessel and usage patterns.

The right marine insurance provider gives you confidence that your vessel is protected and claims will be handled fairly. Taking time to select the right insurer ensures years of worry-free boating.`,
  },
  {
    slug: "racing-yacht-insurance",
    title: "Racing Yacht Insurance: Covering Your Competitive Edge",
    excerpt:
      "Understand the specialized insurance requirements for racing yachts in New Zealand, from club racing to offshore events.",
    author: "Jessica Morrow",
    date: "2026-03-10",
    image:
      "https://images.unsplash.com/photo-1500514966906-fe245eea9344?w=1600&h=900&fit=crop",
    category: "Racing",
    readTime: 8,
    content: `# Racing Yacht Insurance: Covering Your Competitive Edge

Racing yachts represent specialized vessels requiring unique insurance considerations. Unlike cruising yachts used primarily for leisure, racing yachts experience extreme forces, high-speed operations, and competitive pressures that create distinctive insurance challenges. Understanding racing yacht insurance enables you to protect your competitive investment while maintaining appropriate coverage.

## Why Standard Policies Don't Cover Racing

Most standard yacht insurance policies explicitly exclude racing and competitive events. This exclusion reflects the dramatically higher risk profile of racing compared to cruising. Racing involves sustained high speeds, aggressive maneuvering, contact with other vessels, and operation in conditions that cruising sailors typically avoid.

If your vessel is involved in a racing event and your policy excludes racing, your insurer may deny coverage for damage occurring during the event. Some courts have found this exclusion reasonable, given the substantially higher risk racing creates. Attempting to hide racing activity from your insurer constitutes fraud and can result in complete policy cancellation.

## Racing Yacht Coverage Options

Most insurers offering racing yacht coverage provide two options. **Event Coverage** protects your vessel specifically during designated racing events while your regular hull coverage applies for all other periods. This option works well if you race occasionally at specific times throughout the year.

**Full Racing Season Coverage** protects your vessel throughout an entire racing season regardless of whether you're competing in a specific event. This option suits competitors who race frequently or participate in multiple series throughout the season. The additional premium provides comprehensive protection for race-related activities.

## Types of Racing Coverage

Different racing scenarios require different coverage considerations. **Club racing coverage** protects vessels participating in regular club racing events, typically held on weekend mornings. Club racing generally involves shorter distances, smaller geographical areas, and less extreme conditions than offshore racing.

**Offshore racing coverage** protects vessels competing in long-distance ocean races. Offshore racing creates more extreme conditions and greater exposure, requiring higher coverage limits and more comprehensive protection. Well-known races like the Rolex Fastnet and Sydney to Hobart typically require specific offshore racing coverage.

**Match racing coverage** protects vessels in head-to-head competition racing. Match racing involves intensely competitive maneuvers in close proximity to other vessels, creating elevated risk of contact damage. This specialized coverage accommodates the unique risk profile of match racing.

## Coverage Limits for Competitive Vessels

Racing yacht coverage typically provides higher coverage limits than standard policies, reflecting the higher potential damage costs in racing. Many policies include new-for-old replacement coverage, meaning damaged components are replaced with new equivalent items rather than accepting depreciation.

Equipment coverage under racing policies typically includes protection for specialized racing sails, custom-made racing equipment, and technological devices used for performance monitoring. This equipment can represent substantial value on modern racing yachts.

## Crew Injury and Medical Coverage

Racing involves inherent risks of crew injury that exceed those present during cruising. Modern racing yacht insurance includes comprehensive medical coverage for crew members injured while participating in racing events. This coverage proves critical for protecting crew safety and your legal liability if crew members suffer race-related injuries.

Some insurers offer medical payments coverage without requiring fault determination, providing immediate medical benefits for any crew injury occurring during racing. Other policies condition medical benefits on establishing that the injury wasn't caused by crew negligence or alcohol impairment.

## Third-Party Liability Considerations

Racing creates elevated liability risks when yachts are operating in close proximity and at high speeds. Contact between racing yachts, even in protest situations resolved by racing rules, can result in damage claims if the rules don't strictly apply. Spectator injuries during racing events create additional liability exposure.

Racing yacht policies typically include comprehensive third-party liability coverage. Some insurers increase liability limits specifically for racing coverage, recognizing the elevated exposure. If you anticipate participating in major racing events, discuss adequate liability limits with your insurer.

## Equipment Breakdown and Mechanical Coverage

While standard yacht policies typically exclude mechanical breakdowns, many racing yacht policies include equipment breakdown coverage. Racing places extreme stresses on engines, systems, and equipment, increasing mechanical failure risk. Equipment breakdown coverage helps manage the costs of mechanical failures occurring during racing.

Some specialized racing policies include coverage for catastrophic equipment failures, such as engine seizure or transmission failure occurring during a race. However, normal wear and tear and lack of proper maintenance typically remain excluded.

## Special Requirements and Restrictions

Many insurers impose specific requirements on racing vessels to maintain coverage. These might include required annual surveying to confirm seaworthiness, mandatory safety equipment inspections, and compliance with specific racing class rules or offshore racing council requirements.

Some insurers restrict coverage to specific racing series or events. If you plan to participate in international racing events or compete in sanctioned national championships, confirm that your insurer covers your intended racing activities.

## Cost of Racing Coverage

Racing yacht insurance costs substantially more than standard cruising coverage, reflecting the higher risk. Additional premiums for racing coverage typically range from 50% to 100% of your standard cruising premium. The exact premium depends on the type of racing, the frequency of competition, and your vessel's racing record.

Obtaining racing coverage early in your competitive season helps establish baseline rates. If you're new to racing, some insurers offer entry-level racing coverage at lower rates while you establish a claims-free racing history.

## Protecting Your Competitive Investment

Racing yachts represent significant financial investments, and racing creates specialized risks that standard insurance doesn't address. Taking time to secure appropriate racing yacht coverage protects your boat, your crew, and your competitive ambitions. Discuss your racing plans in detail with your insurer to ensure comprehensive coverage that matches your competitive schedule and risk profile.`,
  },
  {
    slug: "blue-water-cruising-nz",
    title: "Blue Water Cruising: Insurance for Offshore Adventures from NZ",
    excerpt:
      "Plan your extended offshore cruising adventure with proper insurance coverage, including blue water cruising insurance designed for serious ocean passages.",
    author: "Tane Pukaki",
    date: "2026-03-05",
    image:
      "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1600&h=900&fit=crop",
    category: "Offshore Cruising",
    readTime: 9,
    content: `# Blue Water Cruising: Insurance for Offshore Adventures from NZ
...
Blue water cruising represents the culmination of many sailors' dreams. With appropriate insurance providing comprehensive protection for the unique challenges of extended ocean passages, you can focus on the adventure rather than financial worries.`,
  ...
  {
    slug: "storm-season-vessel-protection",
    title: "Storm Season Preparation: Protecting Your Vessel in NZ Waters",
    excerpt:
      "Prepare for NZ's challenging storm seasons with proper vessel preparation, maintenance, and insurance coverage to protect your boat year-round.",
    author: "Maia Henderson",
    date: "2026-02-28",
    image:
      "https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=1600&h=900&fit=crop",
    category: "Maintenance & Safety",
    readTime: 7,
    content: `# Storm Season Preparation: Protecting Your Vessel in NZ Waters
...
Proper preparation, appropriate insurance coverage, and realistic risk assessment enable you to face New Zealand's challenging storm seasons with confidence. Take time now to prepare your vessel, upgrade safety equipment, ensure insurance coverage meets your needs, and build crew competence. With these preparations complete, you can enjoy winter boating knowing your vessel and crew are adequately protected.`,
  ...
  {
    slug: "insuring-small-boats-tenders-dinghies-nz",
    title: "Insuring Small Boats, Tenders & Dinghies in New Zealand",
    excerpt:
      "A practical guide to insuring smaller vessels in NZ — what's covered, what's not, and how to get the right protection without overpaying.",
    author: "Liam Ngata",
    date: "2026-02-15",
    image:
      "https://images.unsplash.com/photo-1500514966906-fe245eea9344?w=1600&h=900&fit=crop",
    category: "Guides",
    readTime: 6,
    content: `# Insuring Small Boats, Tenders & Dinghies in New Zealand
